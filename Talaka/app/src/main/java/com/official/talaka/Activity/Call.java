...
public class Call extends AppCompatActivity {
    String Username,Lvl,Gender,call_queue;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdView = findViewById(R.id.ads_call);
...
//        }
    ...
    public void onResume() {
        ...
        call_queue = preferences.getString("Queue_Call", "");
        TextView textView = findViewById(R.id.Status);
        if(call_queue.toString().matches("0")){
            Button button = findViewById(R.id.search_btn);
            button.setVisibility(View.VISIBLE);
            textView.setText("Ready");
        }else {
            textView.setText("Call Limit reached.\ntry again tomorrow.!");
        }
    }
    public void Call_Back(View view) {
        Intent i = new Intent(Call.this, Home.class);
        startActivity(i);
        finish();
    }
    @Override
...
//        ShowError_Dialog3();
    ...
    private void Calling(){
        ...
        //link
        String url = IP.toString() + "Talaka/Users/Practice/Call.php?username=" + Username.toString() + "&lvl=" + Lvl.toString() + "&gender=" + Gender.toString() ;
                        ...
                        if (status.toString().equals("Pending")){
                            ...
                            for (int ii = 0; ii < jsonArray2.length(); ii++) {
                                ...
                                if (statuss.toString().equals("Succesfully")){
                                    Error_Tiitle_Str = ("Queue Alert");
                                    Error_description_Str = ("No Online, Successfully Created Queue For You\n\nyou will get email if another user calling you");
                                    ShowError_Dialog2();

                                    SharedPreferences.Editor editor = preferences.edit();
                                    editor.putString("Worker","Call");
                                    editor.apply();
...
//                                    }
                                    ...
                                    for (int iii = 0; iii < jsonArray3.length(); iii++) {
                                        ...
                                        if (statusss.toString().equals("Pending")){
                                            ...
                                            Intent iiii = new Intent(Call.this, User_Activity.class);
                                            startActivity(iiii);
                                            finish();
    ...
    private void ShowError_Dialog2(){
        builder = new AlertDialog.Builder(Call.this, R.style.AlertDialogTheme);
        view_Error = LayoutInflater.from(Call.this).inflate(
                R.xml.error_dialog,
    ...
    private void ShowError_Dialog3(){
        builder = new AlertDialog.Builder(Call.this, R.style.AlertDialogTheme);
        @SuppressLint("ResourceType") View view = LayoutInflater.from(Call.this).inflate(
                R.xml.sup_dialog,
                (ConstraintLayout) findViewById(R.id.layoutDialogContainer)
        );
        builder.setCancelable(false);
...
//                finish();
    ...
    private void remove_me(){
        //link
      //  String url = IP.toString() + "Talaka/Users/Practice/Delete_Queue.php?user=" + Username.toString() + "&lvl=" + Lvl.toString() + "&type=Call";
        String url = IP.toString() + "Talaka/Users/Practice/Delete_Queue.php?user=" + Username.toString()  + "&type=Call";
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray1.length(); i++) {
                        ...
                        if (status.toString().equals("Succesfully")){
                            try {
//                                Intent serviceIntent = new Intent(Call.this, ForegroundService.class);
//                                stopService(serviceIntent);
                                Intent ii = new Intent(Call.this, Home.class);
                                startActivity(ii);
                                finish();
                            } catch (Exception e) {
                                e.printStackTrace();

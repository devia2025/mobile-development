package com.official.talaka.Extra.adapter;
...
import com.official.talaka.Extra.FoodDetails;
...
public class RecommendedAdapter2 extends RecyclerView.Adapter<RecommendedAdapter2.RecommendedViewHolder> {
    ...
    public RecommendedViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.articles_recycle, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecommendedViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                i.putExtra("lvl", recommendedList.get(position).getlvl());

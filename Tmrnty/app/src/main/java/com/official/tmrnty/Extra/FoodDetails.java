...
//        jcPlayerView.kill();
    ...
    private void Visit(){
        ...
        String url = IP.toString() + "Tmrnty/Training/Training_Visit.php?id=" + id.toString();
...
//        String url = IP.toString() + "Talaka/Users/Article/Training_Like_Checker.php?id=" + id.toString() + "&user=" + ID_User.toString();
//        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null, new com.android.volley.Response.Listener<JSONObject>() {
//            @Override
//            public void onResponse(JSONObject response) {
//
...
//        requestQueue.add(request);
    ...
    private void Like(){
        ...
        String url = IP.toString() + "Tmrnty/Training/Training_Like.php?id=" + id.toString() + "&user=";
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null, new com.android.volley.Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
